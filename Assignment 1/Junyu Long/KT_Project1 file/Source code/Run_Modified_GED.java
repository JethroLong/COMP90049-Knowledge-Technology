...
public class Run_Modified_GED {
	...
	public static void main(String[] args) {
		...
		Modified_EditDistance ed = new Modified_EditDistance();
		...
		try {
			...
			predictionOutput = new PrintWriter(new FileOutputStream("Modified_EditDistance(+1,-1,-1,-1).txt", true));
