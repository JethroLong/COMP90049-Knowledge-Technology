...
public class Run_KeyboardDistance {
	...
	public static void main(String[] args) {
		...
		KeyboardDistance ed = new KeyboardDistance();
		...
		try {
			...
			predictionOutput = new PrintWriter(new FileOutputStream("KeyboardDistance(+1,-1,-1,-1||+1).txt", true));
