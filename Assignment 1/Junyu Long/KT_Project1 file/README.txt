...
form the central data sources for this Project. Programs developed for this
Project are include as well. These files are described in more detail below.
  ...
  - LevenshteinDistance.java, Modified_EditDistance.java, Damerau_Levenshtein.java and KeyboardDistance.java:
    Four class codes refer to implementation of Levenshtein distance, modified edit 
    distance, Damerau- Levenshtein distance and Keyboard distance.

  - Run_Levenshtein.java, Run_Modified_GED.java, Run_DL_distance.java and Run_KeyboardDistance.java:
    Four testing class test distances mentioned above respectively.

  - Evaluation.java: a class to calculate accuracies of algorithms above. 
